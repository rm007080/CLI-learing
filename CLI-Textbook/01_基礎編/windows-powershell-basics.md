# Windows ではじめる CLI 入門 — いっしょに PowerShell デビューしよっ！
...
Path
----
C:\Users\あなたのユーザー名\Desktop\cli-practice
```
...
```powershell
    ディレクトリ: C:\Users\あなたのユーザー名\Desktop\cli-practice
...
Path
----
C:\Users\あなたのユーザー名\Desktop\cli-practice\photos
```
...
```powershell
    ディレクトリ: C:\Users\あなたのユーザー名\Desktop\cli-practice\logs

Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
d-----        2025/09/26     14:26                2025

    ディレクトリ: C:\Users\あなたのユーザー名\Desktop\cli-practice\logs\2025
